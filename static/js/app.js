        ...
        async function ExplainDeep() {
            ...
            showReviewLoading('Making step-by-step explanations for all your questions…', {
            ...
            try {
                const response = await fetch('/api/explain-deep', {
                    ...
                    body: JSON.stringify({
                        ...
                        // The main Explain in Detail action explains the whole homework set.
                        // Keep question_index null; the tutor-only one-question workflow can
                        // still send an explicit index through its own action.
                        question_index: null
                    })
                });
