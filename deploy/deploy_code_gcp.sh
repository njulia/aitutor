...
gcloud run services update "${SERVICE}" \
  ...
  --max-instances=10 \
  --cpu-boost \
  --update-env-vars="^#^BUSINESS_CONTACT_EMAIL=${BUSINESS_CONTACT_EMAIL}#ADMIN_EMAILS=${ADMIN_EMAILS}#QUICK_REVIEW_PROVIDER=${QUICK_REVIEW_PROVIDER}#QUICK_REVIEW_MODEL=${QUICK_REVIEW_MODEL}#DETAIL_REVIEW_PROVIDER=${DETAIL_REVIEW_PROVIDER}#DETAIL_REVIEW_MODEL=${DETAIL_REVIEW_MODEL}#FALLBACK_REVIEW_PROVIDER=${FALLBACK_REVIEW_PROVIDER}#FALLBACK_REVIEW_MODEL=${FALLBACK_REVIEW_MODEL}" \
