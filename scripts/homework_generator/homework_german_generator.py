#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Generate deterministic German homework for England Years 1-6."""
...
SUBJECT = "German"
SLUG = "german"
GERMAN_TOPICS_BY_YEAR = {year: topics_for_subject(SUBJECT, year) for year in range(1, 7)}


def generate_german_homework(year_group: int, topic: str, index: int) -> tuple[str, list[str]]:
