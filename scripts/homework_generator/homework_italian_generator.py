#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Generate deterministic Italian homework for England Years 1-6."""
...
SUBJECT = "Italian"
SLUG = "italian"
ITALIAN_TOPICS_BY_YEAR = {year: topics_for_subject(SUBJECT, year) for year in range(1, 7)}


def generate_italian_homework(year_group: int, topic: str, index: int) -> tuple[str, list[str]]:
