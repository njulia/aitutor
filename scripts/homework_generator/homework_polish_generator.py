#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Generate deterministic Polish homework for England Years 1-6."""
...
SUBJECT = "Polish"
SLUG = "polish"
POLISH_TOPICS_BY_YEAR = {year: topics_for_subject(SUBJECT, year) for year in range(1, 7)}


def generate_polish_homework(year_group: int, topic: str, index: int) -> tuple[str, list[str]]:
