#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Generate deterministic Physical Education homework for Years 1-6."""
...
PHYSICAL_EDUCATION_TOPICS_BY_YEAR = {year: topics_for_subject(SUBJECT, year) for year in range(1, 7)}


def generate_physical_education_homework(year_group: int, topic: str, index: int) -> tuple[str, list[str]]:
