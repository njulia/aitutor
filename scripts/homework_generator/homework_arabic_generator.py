#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Generate deterministic Arabic homework for England Years 1-6."""
...
SUBJECT = "Arabic"
SLUG = "arabic"
ARABIC_TOPICS_BY_YEAR = {year: topics_for_subject(SUBJECT, year) for year in range(1, 7)}


def generate_arabic_homework(year_group: int, topic: str, index: int) -> tuple[str, list[str]]:
