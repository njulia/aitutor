...
def ensure_static_files():
    ...
    eleven_plus_src = os.path.join(project_root, 'templates', 'elevenplus-practice.html')
    eleven_plus_dest = os.path.join(project_root, 'static', 'elevenplus-practice.html')

    if os.path.exists(eleven_plus_src) and not os.path.exists(eleven_plus_dest):
        shutil.copy(eleven_plus_src, eleven_plus_dest)
        print("✓ Copied elevenplus-practice.html to static folder")
...
def main():
    ...
    print(f"  • http://localhost:5000/elevenplus-practice")
